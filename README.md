...
$$\frac{T_{i, j}^{n+1} - T_{i, j}^{n}}{\tau} = \varkappa(\frac{\frac{T_{i+1, j}^{n} - T_{i, j}^{n}}{h} -  
 \frac{T_{i, j}^{n} - T_{i-1, j}^{n}}{h}}{h} + \frac{\frac{T_{i, j+1}^{n} - T_{i, j}^{n}}{h} -  
 \frac{T_{i, j}^{n} - T_{i, j-1}^{n}}{h}}{h})$$
